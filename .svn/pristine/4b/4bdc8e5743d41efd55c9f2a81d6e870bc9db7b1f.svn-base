...
/**
 * @ClassName LineChartDistanceView
 * @Description 折线图的例子 <br/>
 *  * 	~_~
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class LineChartSpeedView extends ChartBaseView implements Runnable {
    ...
    public LineChartSpeedView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public LineChartSpeedView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public LineChartSpeedView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void chartRender() {
        try {
            ...
            //标题
            chart.setTitle("水中平板运动治疗记录统计");
            chart.addSubtitle("(速度)");
    ...
    private void chartDataSet() {
        ...
        dataSeries1.add(21d);
        dataSeries1.add(30d);
        LineData lineData1 = new LineData("初评", dataSeries1, Color.rgb(234, 83, 71));
        ...
        dataSeries2.add(0d);
        dataSeries2.add(0d);
        dataSeries2.add((double) 23);
        dataSeries2.add((double) 29);
        dataSeries2.add((double) 37);

        LineData lineData2 = new LineData("中评", dataSeries2, Color.rgb(75, 166, 51));
        ...
        LineData lineData3 = new LineData("末评", dataSeries3, Color.rgb(123, 89, 168));
