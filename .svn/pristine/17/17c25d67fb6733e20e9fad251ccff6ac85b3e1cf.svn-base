 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class RadarChartView extends ChartBaseView {
    ...
    private void chartRender() {
        try {
            ...
            chart.setTitle("功能独立性评定统计");
            chart.addSubtitle("(Functional independence evaluation of statistics)");
    ...
    private void chartDataSet() {
        ...
        RadarData lineData1 = new RadarData("中评", dataSeriesA,
        ...
        RadarData lineData2 = new RadarData("初评", dataSeriesB,
        ...
        RadarData lineData3 = new RadarData("末评", dataSeriesC,
