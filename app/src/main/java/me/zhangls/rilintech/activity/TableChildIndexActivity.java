...
public class TableChildIndexActivity extends TableParentIndexActivity {
    ...
    public static final String ACTION_INTENT_TABLE_DELETE = "me.zhangls.rilintech.activity.tableChildIndexActivity.delete";
    //popwindow是否显示
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myIntentFilter.addAction(TableChildInfoActivity.ACTION_INTENT_TABLE_ADD);
        myIntentFilter.addAction(TableChildInfoActivity.ACTION_INTENT_TABLE_EDIT);
        myIntentFilter.addAction(ACTION_INTENT_TABLE_DELETE);
        //动态注册广播
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 1006:
                        ...
                        if (200 == delete_code) {
                            //发广播
                            Intent intent = new Intent(ACTION_INTENT_TABLE_DELETE);
    ...
    private void getSharedPreferencesData() {
        ...
        L.d("aa", " menu_lib_id--index===" + menu_lib_id);
        pos = getIntent().getIntExtra("position", 0);
        main_position = getIntent().getIntExtra("main_position", 0);

        indexTextName=getIntent().getStringExtra("titleName");
    ...
    private void deleteSthItem() {
        ...
        String url = "&&groupid=" + groupid + "&&patient_info_id=" + patient_info_id +
                "&&menu_lib_id=" + menu_lib_id+"&&user_auth_id="+user_auth_id;
        delete_code = HttpUtil.doPost(NetUrlAddress.Common_destroy_url + url, "");
        L.d("aa", "delete_code=" + delete_code);
    ...
    public List<Model_one> initData() {
        ...
        L.d("uu","patient_info_id===="+patient_info_id);
        L.d("uu","menu_lib_id===="+menu_lib_id);
        L.d("uu","user_auth_id===="+user_auth_id);
...
//            L.d("aa", "list_infos=" + list_infos);
    ...
    private class MybroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TableChildInfoActivity.ACTION_INTENT_TABLE_ADD.equals(action)) {
                lists_note.clear();
                lists_person.clear();
                lists_time.clear();
            ...
            } else if (TableChildInfoActivity.ACTION_INTENT_TABLE_EDIT.equals(action)) {
                lists_note.clear();
                lists_person.clear();
                lists_time.clear();
            ...
            } else if (ACTION_INTENT_TABLE_DELETE.equals(action)) {
                lists_note.clear();
                lists_person.clear();
                lists_time.clear();
