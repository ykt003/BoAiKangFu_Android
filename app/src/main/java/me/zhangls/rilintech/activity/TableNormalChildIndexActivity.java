...
import me.zhangls.rilintech.model.NormalTableModelManager11;
import me.zhangls.rilintech.model.NormalTableModelManager12;
    ...
    private List<NormalTableModel> getModelList(String menu_lib) {
        ...
        switch (menu_lib) {
            ...
            case "208"://康复评价会记录表
                ...
                break;
            case "153"://阶段小结
                list_info = NormalTableModelManager12.getTableItemList();
                break;
            case "154"://出院总结
                list_info = NormalTableModelManager11.getTableItemList();
                break;
        }
        return list_info;
    }
