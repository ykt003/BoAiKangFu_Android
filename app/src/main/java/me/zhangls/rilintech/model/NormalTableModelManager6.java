 ...
 */
public class NormalTableModelManager6 {
    ...
    public static ArrayList<NormalTableModel> getTableItemList() {
        ...
        normalTableModel = new NormalTableModel();
        normalTableModel.setLeftText("涡流");
        normalTableModel.setType(RADIOGROUP);
        list_ll = new ArrayList<>();
        list_ll.add("开");
        list_ll.add("关");
        normalTableModel.setDicText(list_ll);
        normalTableModel.setName("vortex");
        scaleList.add(normalTableModel);

        normalTableModel = new NormalTableModel();
        normalTableModel.setLeftText("光疗");
        normalTableModel.setType(RADIOGROUP);
        list_ll = new ArrayList<>();
        list_ll.add("开");
        list_ll.add("关");
        normalTableModel.setDicText(list_ll);
        normalTableModel.setName("phototherapy");
        scaleList.add(normalTableModel);
