 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class LineChartDistanceView extends ChartBaseView implements Runnable {
    ...
    public LineChartDistanceView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public LineChartDistanceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public LineChartDistanceView(Context context, AttributeSet attrs, int defStyle) {
